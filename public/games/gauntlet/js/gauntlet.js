Gauntlet = function() {
  ...
  var cfg = {
    ...
    images: [
      { id: 'backgrounds', url: "/games/gauntlet/images/backgrounds.png" }, // http://opengameart.org/content/gauntlet-like-tiles
      { id: 'entities',    url: "/games/gauntlet/images/entities.png"    }  // http://opengameart.org/forumtopic/request-for-tileset-spritesheet-similar-to-gauntlet-ii 
    ],

    sounds: [
      { id: 'lostcorridors',   name: '/games/gauntlet/sounds/music.lostcorridors',   formats: ['mp3', 'ogg'], volume: 1.0, loop: true             }, // http://luckylionstudios.com/
      { id: 'bloodyhalo',      name: '/games/gauntlet/sounds/music.bloodyhalo',      formats: ['mp3', 'ogg'], volume: 0.5, loop: true             }, // (ditto)
      { id: 'citrinitas',      name: '/games/gauntlet/sounds/music.citrinitas',      formats: ['mp3', 'ogg'], volume: 0.5, loop: true             }, //
      { id: 'fleshandsteel',   name: '/games/gauntlet/sounds/music.fleshandsteel',   formats: ['mp3', 'ogg'], volume: 0.5, loop: true             }, //
      { id: 'mountingassault', name: '/games/gauntlet/sounds/music.mountingassault', formats: ['mp3', 'ogg'], volume: 0.5, loop: true             }, //
      { id: 'phantomdrone',    name: '/games/gauntlet/sounds/music.phantomdrone',    formats: ['mp3', 'ogg'], volume: 0.5, loop: true             }, //
      { id: 'thebeginning',    name: '/games/gauntlet/sounds/music.thebeginning',    formats: ['mp3', 'ogg'], volume: 0.5, loop: true             }, //
      { id: 'warbringer',      name: '/games/gauntlet/sounds/music.warbringer',      formats: ['mp3', 'ogg'], volume: 0.5, loop: true             }, //
      { id: 'gameover',        name: '/games/gauntlet/sounds/gameover',              formats: ['mp3', 'ogg'], volume: 0.5                         }, //
      { id: 'victory',         name: '/games/gauntlet/sounds/victory',               formats: ['mp3', 'ogg'], volume: 1.0                         }, //
      { id: 'femalepain1',     name: '/games/gauntlet/sounds/femalepain1',           formats: ['mp3', 'ogg'], volume: 0.3                         }, // http://www.premiumbeat.com/sfx/
      { id: 'femalepain2',     name: '/games/gauntlet/sounds/femalepain2',           formats: ['mp3', 'ogg'], volume: 0.3                         }, // (ditto)
      { id: 'malepain1',       name: '/games/gauntlet/sounds/malepain1',             formats: ['mp3', 'ogg'], volume: 0.3                         }, //
      { id: 'malepain2',       name: '/games/gauntlet/sounds/malepain2',             formats: ['mp3', 'ogg'], volume: 0.3                         }, //
      { id: 'exitlevel',       name: '/games/gauntlet/sounds/exitlevel',             formats: ['mp3', 'ogg'], volume: 1.0,                        }, //
      { id: 'highscore',       name: '/games/gauntlet/sounds/highscore',             formats: ['mp3', 'ogg'], volume: 1.0,                        }, //
      { id: 'firewarrior',     name: '/games/gauntlet/sounds/firewarrior',           formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //   NOTE: ie has limit of 40 <audio> so be careful with pool amounts
      { id: 'firevalkyrie',    name: '/games/gauntlet/sounds/firevalkyrie',          formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'firewizard',      name: '/games/gauntlet/sounds/firewizard',            formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'fireelf',         name: '/games/gauntlet/sounds/fireelf',               formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'collectgold',     name: '/games/gauntlet/sounds/collectgold',           formats: ['mp3', 'ogg'], volume: 0.5, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'collectpotion',   name: '/games/gauntlet/sounds/collectpotion',         formats: ['mp3', 'ogg'], volume: 0.5, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'collectkey',      name: '/games/gauntlet/sounds/collectkey',            formats: ['mp3', 'ogg'], volume: 0.5, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'collectfood',     name: '/games/gauntlet/sounds/collectfood',           formats: ['mp3', 'ogg'], volume: 0.5, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'generatordeath',  name: '/games/gauntlet/sounds/generatordeath',        formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'monsterdeath1',   name: '/games/gauntlet/sounds/monsterdeath1',         formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'monsterdeath2',   name: '/games/gauntlet/sounds/monsterdeath2',         formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'monsterdeath3',   name: '/games/gauntlet/sounds/monsterdeath3',         formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'opendoor',        name: '/games/gauntlet/sounds/opendoor',              formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 } //
    ],

    levels: [
      { name: 'Test Level',     url: "/games/gauntlet/levels/testlevel.png", floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: null }, 
      { name: 'Training',       url: "/games/gauntlet/levels/trainer1.png",  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Shoot ghosts and find the exit" },
      { name: 'Training Two',   url: "/games/gauntlet/levels/trainer2.png",  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Watch out for demon fire" },
      { name: 'Training Three', url: "/games/gauntlet/levels/trainer3.png",  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Find keys to open doors" },
      { name: 'Training Four',  url: "/games/gauntlet/levels/trainer4.png",  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Eat and drink to restore health" },
      { name: 'Training Five',  url: "/games/gauntlet/levels/trainer5.png",  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Collect treasure for high score" },
      { name: 'Training Six',   url: "/games/gauntlet/levels/trainer6.png",  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Destroy monster generators" },
      { name: 'Training Seven', url: "/games/gauntlet/levels/trainer7.png",  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Use potions to destroy all monsters" },
      { name: 'Dungeon One',    url: "/games/gauntlet/levels/level1.png",    floor: FLOOR.WOOD,             wall: WALL.CONCRETE,         music: 'citrinitas',      score:  1000, help: "Training is over!<br><br> Welcome to the Dungeon!" },
      { name: 'Dungeon Two',    url: "/games/gauntlet/levels/level2.png",    floor: FLOOR.WOOD,             wall: WALL.CONCRETE,         music: 'citrinitas',      score:  2000, help: null },
      { name: 'Dungeon Three',  url: "/games/gauntlet/levels/level3.png",    floor: FLOOR.DARK_STONE,       wall: WALL.BLUE,             music: 'fleshandsteel',   score:  3000, help: null },
      { name: 'Dungeon Four',   url: "/games/gauntlet/levels/level4.png",    floor: FLOOR.DARK_STONE,       wall: WALL.BLUE,             music: 'fleshandsteel',   score:  4000, help: null },
      { name: 'Dungeon Five',   url: "/games/gauntlet/levels/level5.png",    floor: FLOOR.BROWN_LAMINATE,   wall: WALL.CONCRETE,         music: 'phantomdrone',    score:  5000, help: null },
      { name: 'Dungeon Six',    url: "/games/gauntlet/levels/level6.png",    floor: FLOOR.BROWN_LAMINATE,   wall: WALL.CONCRETE,         music: 'phantomdrone',    score:  6000, help: null },
      { name: 'Dungeon Seven',  url: "/games/gauntlet/levels/level7.png",    floor: FLOOR.PURPLE_LAMINATE,  wall: WALL.PURPLE_COBBLE,    music: 'thebeginning',    score:  7000, help: null },
      { name: 'Dungeon Eight',  url: "/games/gauntlet/levels/level8.png",    floor: FLOOR.WOOD,             wall: WALL.BLUE_BRICK,       music: 'mountingassault', score:  8000, help: null },
      { name: 'Dungeon Nine',   url: "/games/gauntlet/levels/level9.png",    floor: FLOOR.PURPLE_LAMINATE,  wall: WALL.CONCRETE,         music: 'fleshandsteel',   score:  9000, help: null },
      { name: 'Dungeon Ten',    url: "/games/gauntlet/levels/level10.png",   floor: FLOOR.WOOD,             wall: WALL.BLUE_BRICK,       music: 'warbringer',      score: 10000, help: "Final Level<br><br>Good Luck!" }
    ],

    keys: [
      { key: Game.Key.ONE,    mode: 'up',   state: 'menu',    action: function()    { var startDate = new Date();
        globalThis.localStorage['startDate'] = Date.parse(startDate);
        this.start(PLAYER.WARRIOR);      } },
      { key: Game.Key.TWO,    mode: 'up',   state: 'menu',    action: function()    { var startDate = new Date();
        globalThis.localStorage['startDate'] = Date.parse(startDate);
        this.start(PLAYER.VALKYRIE);     } },
      { key: Game.Key.THREE,  mode: 'up',   state: 'menu',    action: function()    { var startDate = new Date();
        globalThis.localStorage['startDate'] = Date.parse(startDate);
        this.start(PLAYER.WIZARD);       } },
      { key: Game.Key.FOUR,   mode: 'up',   state: 'menu',    action: function()    { var startDate = new Date();
        globalThis.localStorage['startDate'] = Date.parse(startDate);
        this.start(PLAYER.ELF); } },
  ...
  var game = {
    ...
    onlose: function(event, previous, current) { this.winlosefade(10000);
      var startGameTime = Number(globalThis.localStorage.startDate)/1000;
      if (this.player.score > Number(globalThis.localStorage['gauntlet.score'])){
        var timeDelta = (Number(globalThis.localStorage.endDate) - Number(globalThis.localStorage.startDate))/1000;
        var xhttp = new XMLHttpRequest();
        var url = `/games/gauntlet/${globalThis.localStorage['gauntlet.nlevel']}/${this.player.score}`;
        xhttp.open("POST", url, true);
        xhttp.send();
      } else {
        var timeDelta = (Number(globalThis.localStorage.endDate) - Number(globalThis.localStorage.startDate))/1000;
        var xhttp = new XMLHttpRequest();
        var url = `/games/gauntlet/${globalThis.localStorage['gauntlet.nlevel']}/${globalThis.localStorage['gauntlet.score']}`;
        xhttp.open("POST", url, true);
        xhttp.send();
      }
      
      var xhttp = new XMLHttpRequest();
      var url = `/games/gauntlet/${globalThis.localStorage['gauntlet.nlevel']}/${this.player.score}/${startGameTime}/${timeDelta}`;
      xhttp.open("POST", url, true);
      xhttp.send();
      location.reload(); },
    ...
    onPlayerDeath:  function()       { var endDate = new Date();
      globalThis.localStorage['endDate'] = Date.parse(endDate);
      this.lose(); },
    ...
    loadLevel: function()       { var xhttp = new XMLHttpRequest();
                                  var url = '/games/gauntlet';
                                  xhttp.onreadystatechange = function() {
                                    if (this.readyState == 4 && this.status == 200) {
                                        // Typical action to be performed when the document is ready:
                                        var data = JSON.parse(xhttp.responseText);
                                        globalThis.localStorage['gauntlet.nlevel'] = Number(data.level);
                                        globalThis.localStorage['gauntlet.score'] = Number(data.highscore);
                                    }
                                  };
                                  xhttp.open('GET', url, true);
                                  xhttp.send();
                                  return to.number(globalThis.localStorage['gauntlet.nlevel'], 1); },
    ...
    loadHighScore: function() { return to.number(globalThis.localStorage['gauntlet.score'], 0); },
